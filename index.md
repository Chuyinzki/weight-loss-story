...
# How I Lost 50 Pounds Watching Television: A Weight Loss Story for Normal People
...
## How I Got Here (Or Rather, How I Got There)
...
<figure class="story-figure">
  <img src="{{ site.baseurl }}/assets/images/weight-trend-2022.png" alt="Fitbit chart for 2022 showing a steady decline across the year from just above 200 pounds toward 190." loading="lazy">
  <figcaption>2022 was the workhorse year. I started that year at about 215 pounds and finished it around 190. This is where most of the weight came off: a steady, unspectacular, absolutely beautiful downward slope.</figcaption>
</figure>
...
## The Bike, the Shows, and the $25 Setup

The stationary bike was chosen for one reason: I could watch TV on it.
...
## The Spreadsheet Enters the Chat

Around the time I hit the 190s, the weight started to slow down. Same effort, less return. Which meant it was time to actually look at what I was eating.
...
Spread throughout the day, two more protein shakes and two more coffees. End of the day, three more eggs.

Also baked into the plan was a line item I called the kids' leftovers. Chicken nuggets. Apple slices. Whatever survived that looked edible. The ones that had been too handled or too grubby went to the dogs, so nothing went to waste either way. The ones I actually ate were already accounted for in the plan. If there were none, those were the days I lost a little extra. If there were, it was already in the budget.

My goal was never 50 pounds or 30 pounds or even 10 pounds. It was always 1 or 2 pounds over the next 1 or 2 weeks. Small enough to be real. Small enough to actually track. Only now, looking back, do I think, wow, that is a lot of weight. During it I was just trying to lose the next pound. <span class="story-ref" data-source="THE WIRE" tabindex="0" aria-label="Reference from The Wire">All in the game</span>.

---

## The Seitan Chapter (Bear With Me)
...
Instead, I say yes. Yes, absolutely, I am going to eat those mangos. But first I am going to check the spreadsheet and do the next item on it. Maybe it is a coffee. Maybe it is a protein shake. It takes two minutes. I drink 30 ounces of water along with it. By the time I am done I am full, and somehow the mangos have lost their grip. Sometimes I forget about them entirely. I just needed to fill the space with something first.

This is not willpower. It is a redirect. Redirects are much easier to execute than refusals.

---

## The Part Where I Mess Everything Up

Here is what I want you to really pay attention to because it is the part most people leave out of these stories.

I entered 2025 at 177 pounds. Close to 40 pounds down over a few years. Feeling good. Maybe a little too good. I decided it was time to pivot toward muscle gain, started swapping cycling time for more strength training, building up the volume throughout the week.
...
## What Actually Happened to the Fat

Here is something I thought about after losing a significant amount of weight: where did it go? It cannot just disappear.

It does not. When your body burns fat for energy, the fat molecules get broken down and ultimately oxidized. The carbon and hydrogen atoms combine with oxygen to produce carbon dioxide and water. The byproducts are CO2, which you breathe out, and water, which you lose through breath, sweat, and urine. You literally exhale a meaningful portion of the fat you lose.

Which means some of the energy from that Costco hot dog you ate five years ago is right there in the mirror, still visible on the gut. And every hard workout is you breathing it out, one exhale at a time. I find that genuinely motivating for reasons I cannot fully explain.

---

## What I Actually Think Is Going On

The whole system, when I look at it from a distance, is really just a series of answers to one question: how do I make the food noise manageable enough to get through the day?

High water intake helps. You are filling your stomach with something that has no calories. Caffeine helps with appetite suppression. Protein helps with satiety. The spreadsheet helps because when the noise shows up you have something to do with it other than white-knuckling through it. The redirect helps because it gives you a way to say yes instead of no.

And doing the workout first thing in the morning helps more than anything else, because once it is done the rest of the day is just maintenance. It is not hanging over you. You cannot talk yourself out of it later because later has already happened.

When it comes to planning the food: remember P90X? It came with a meal plan that required what felt like a full kitchen staff to execute. My food plan is to eat the same thing every single day so that there is nothing to think about. Same meals, same times, same containers. The goal is to remove every decision that does not need to be made.

For people where the food noise is more severe than what I have described, there are medical tools now, GLP-1 medications and other options, that are worth looking into. The higher your body fat percentage, the more your hormones are actively working against you, and that is a chemistry problem not a willpower problem. The biology can genuinely fight you from the inside, and there is no reason to ignore tools that help with that.
